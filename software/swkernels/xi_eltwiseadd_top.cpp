...
void eltwise_add_singleio(IO_DATA_TYPE *pi8_a1, IO_DATA_TYPE *pi8_b1, IO_DATA_TYPE *pi8_s1, int i4_n, int relu_en, int io_6bit)
{
...
void * eltwaddRoutine_multiplethread_singleio(void *arguments)
{
	//	std::cout << "\n** NMS Thread " << std::endl;
...
void EltwiseaddWrapper(IO_DATA_TYPE* inArray1, IO_DATA_TYPE* inArray2, IO_DATA_TYPE* outArray1, int *scalar_eltwiseadd_args)
{
	...
	for(int th=0;th<NUM_ELTW_THREADS;th++)
	{
		...
		pthread_create(&eltwaddThread[th], NULL, eltwaddRoutine_multiplethread_singleio, (void *)&layerArgs[th]);
...
#if XI_SINGLE_IO_PORT_EN
void EltwiseaddWrapper(IO_DATA_TYPE* inArray1, IO_DATA_TYPE* inArray3, IO_DATA_TYPE* outArray1, int *scalar_eltwiseadd_args)
{
	...
	eltwise_add_singleio(inArray1, inArray3, outArray1, nsize, relu_en, io_6bit);
}
#else
void EltwiseaddWrapper(IO_DATA_TYPE* inArray1, IO_DATA_TYPE* inArray2, IO_DATA_TYPE* inArray3, IO_DATA_TYPE* inArray4, IO_DATA_TYPE* outArray1, IO_DATA_TYPE* outArray2, int *scalar_eltwiseadd_args)
{
